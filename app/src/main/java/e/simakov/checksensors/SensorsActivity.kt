...
class SensorsActivity : SensorDiscoveryAssistant() {
    ...
    private val magnetometer = "magnetometer"
    private val sensorAccelerometer = "sensorAccelerometer"
    private val sensorAmbientTemperature = "sensorAmbientTemperature"
    private val sensorGravity = "sensorGravity"
    private val sensorGyroscope = "sensorGyroscope"
    private val sensorLight = "sensorLight"
    private val sensorLinearAccelerator = "sensorLinearAccelerator"
    private val sensorMagneticField = "sensorMagneticField"
    private val sensorTypeOrientation = "sensorTypeOrientation"
    private val sensorPressure = "sensorPressure"
    private val sensorProximity = "sensorProximity"
    private val sensorRelativeHumidity = "sensorRelativeHumidity"
    private val sensorRotationVector = "sensorRotationVector"
    private val sensorTemperature = "sensorTemperature"
